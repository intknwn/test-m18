...
var initSlider = function initSlider() {
  var slides = document.querySelectorAll(".slider__slide-item");
  ...
  var handlePrevClick = function handlePrevClick() {
    ...
    slides.forEach(function (slide, index) {
      slide.style.transform = "translateX(-".concat(slideWidth * currentSlideIndex, "px)");
  ...
  var debouncedHandleResize = lodash_debounce__WEBPACK_IMPORTED_MODULE_0___default()(handleResize, 150);
